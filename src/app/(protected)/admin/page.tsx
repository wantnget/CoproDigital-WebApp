...
import { Inbox, Users, type LucideIcon } from "lucide-react";
...
export default function AdminDashboardPage() {
    const { isAuthorized, profile, loading: authLoading } = useProtectedRoute({
        allowedRoles: ["admin"],
    });
    ...
    const sections: DashboardSection[] = [
        {
            ...
            description: "Accesos rápidos para mantener los procesos al día.",
            cards: [
                {
                    title: "Bandeja de solicitudes",
                    description: "Aprueba o rechaza las solicitudes crediticias.",
                    href: "/admin/bandeja",
                    icon: Inbox,
                    accent: "amber",
                },
                {
                    title: "Usuarios",
                    description: "Monitorea el estado de los usuarios registrados.",
                    href: "/admin/usuarios",
                    icon: Users,
                    accent: "amber",
                },
        ...
        },
        {
            ...
            description: "Administra roles y equipos desde un solo lugar.",
            cards: [
                {
                    title: "Usuarios",
                    description: "Crea usuarios nuevos y administra sus roles.",
                    href: "/admin/usuarios",
                    icon: Users,
                    accent: "blue",
                },
                ...
                <div className="mb-14 flex items-center gap-8 sm:mb-20">
                    <div className="flex-1">
                        ...
                        <p className="max-w-xl text-base leading-relaxed text-slate-600">
                            Accede directo a los módulos que usas a diario:
                            gestiona trámites, administra usuarios o ajusta
                            parámetros.
                        </p>
                    </div>
                    <svg
                    ...
                    >
                        ...
                        <rect x="55" y="40" width="110" height="80" rx="6" fill="#B5D4F4" stroke="#185FA5" strokeWidth="1.5" />
                        ...
                        <circle cx="40" cy="60" r="14" fill="#CECBF6" stroke="#534AB7" strokeWidth="1.5" />
                        <circle cx="40" cy="60" r="5" fill="#7F77DD" />
                        <circle cx="180" cy="100" r="12" fill="#9FE1CB" stroke="#0F6E56" strokeWidth="1.5" />
                        <path d="M175 100 l4 4 l8 -8" stroke="#0F6E56" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
                        <circle cx="170" cy="50" r="8" fill="#FAC775" />
                        <path d="M30 110 q10 -10 20 0 q10 10 20 0" stroke="#7F77DD" strokeWidth="1.5" fill="none" strokeLinecap="round" />
                    </svg>
                </div>
